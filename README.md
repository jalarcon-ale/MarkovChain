...
The Python file Markov_SIR contains the code used to generate the data in the pre-print "Computation of Expected Epidemic Duration". The discrete-time Markovian SIR model used in the manuscript is introduced next.
